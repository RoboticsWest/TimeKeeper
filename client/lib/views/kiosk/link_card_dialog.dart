...
void showLinkCardDialog(BuildContext context, WidgetRef ref, String scannedUid) {
  PopupDialog.warn(
                ...
                return FilledButton.icon(
                  ...
                  onPressed: () async {
                    ...
                    if (result.success) {
                      ...
                      ToastOverlay.success(context, title: 'Card Linked', message: 'Linked card to $name');
                    } else {
                      ToastOverlay.error(context, title: 'Link Failed', message: result.message ?? 'An error occurred');
                    }
                  },
                );
              },
