...
@$core.Deprecated('Use uploadScheduleIcsRequestDescriptor instead')
const UploadScheduleIcsRequest$json = {
  '1': 'UploadScheduleIcsRequest',
  '2': [
    {'1': 'ics_data', '3': 1, '4': 1, '5': 12, '10': 'icsData'},
  ],
};

/// Descriptor for `UploadScheduleIcsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List uploadScheduleIcsRequestDescriptor =
    $convert.base64Decode(
        'ChhVcGxvYWRTY2hlZHVsZUljc1JlcXVlc3QSGQoIaWNzX2RhdGEYASABKAxSB2ljc0RhdGE=');

@$core.Deprecated('Use uploadScheduleIcsResponseDescriptor instead')
const UploadScheduleIcsResponse$json = {
  '1': 'UploadScheduleIcsResponse',
};

/// Descriptor for `UploadScheduleIcsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List uploadScheduleIcsResponseDescriptor =
    $convert.base64Decode('ChlVcGxvYWRTY2hlZHVsZUljc1Jlc3BvbnNl');
