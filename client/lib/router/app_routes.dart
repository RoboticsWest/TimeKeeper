...
enum AppRoute {
  ...
  notifications(path: '/notifications', name: 'notifications', railIndex: 5),
  attendance(path: '/attendance', name: 'attendance', railIndex: 6),
  statistics(path: '/statistics', name: 'statistics', railIndex: 7);
