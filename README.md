...
## Quickstart
1. Download the server from the latest [release](https://github.com/RoboticsWest/TimeKeeper/releases)
...
## Documentation
Check [documentation](https://RoboticsWest.github.io/TimeKeeper/) for more details.
